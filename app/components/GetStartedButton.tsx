...
const StyledWrapper = styled.div`
  .button {
    --primary: #000000; /* changed to black to remove red/yellow hover color */
    --neutral-1: #f7f8f7;
    --neutral-2: #e7e7e7;
    --radius: 14px;
    ...
    color: #000; /* ensure button text remains black */
  ...
  .loader {
    ...
    border-radius: 50%;
    animation: spin 0.7s cubic-bezier(0.4, 0, 0.2, 1) infinite, pulse 1.2s ease-in-out infinite;
    margin: 0 auto;
    display: block;
  ...
  @keyframes pulse {
    0%, 100% { box-shadow: 0 2px 8px 0 rgba(79,70,229,0.10); }
    50% { box-shadow: 0 4px 16px 0 rgba(79,70,229,0.18); }
  }
  `;
