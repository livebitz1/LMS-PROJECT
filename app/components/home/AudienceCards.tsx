  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <article
          className={`
            group relative p-8 rounded-3xl bg-white border border-gray-100 shadow-sm
        ...
        >
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

          <div className="relative flex flex-col h-full">
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-emerald-50 flex items-center justify-center shadow-inner">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium flex items-center gap-1">
        ...
        >
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-indigo-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

          <div className="relative flex flex-col h-full">
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center shadow-inner">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1.5 rounded-full bg-indigo-50 text-indigo-700 text-xs font-medium flex items-center gap-1">
                <User className="w-3 h-3" />
                Find Tutors
              </span>
              <span className="px-3 py-1.5 rounded-full bg-indigo-50 text-indigo-700 text-xs font-medium flex items-center gap-1">
